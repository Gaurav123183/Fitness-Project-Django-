...
urlpatterns = [
    ...
    path('changeprofile/',views.modify),
    path('modisuccess/',views.modisuccess),
    path('deletepage/',views.deletepage),
    path('deletesuccess/',views.delete),
    path('search/',views.search),
    path('searchpro/',views.searchpro),
    path('generate_ai_advice/',views.generate_ai_advice),
